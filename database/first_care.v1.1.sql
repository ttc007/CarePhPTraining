...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th9 11, 2019 lúc 12:58 PM
...
(1, 'Đợt 1', 1, '2018-02-08', 1, NULL),
(2, 'Đợt 2', 1, '2018-06-18', 1, NULL),
(3, 'Đợt 3', 1, '2018-09-07', 1, NULL),
(4, 'Đợt 1', 2, '2019-03-04', 0, NULL),
(5, 'Đợt 2', 2, '2019-06-15', 1, NULL),
(6, 'Đợt 3', 2, '2019-09-18', 1, NULL),
(7, 'Đợt 4', 2, '2019-12-15', 1, NULL),
...
INSERT INTO `farmers` (`id`, `name`, `phone`, `address`, `village_id`, `ward_id`) VALUES
(1, 'Nguyễn Văn A', '0912335566', NULL, 2, 4),
(2, 'Trần Văn B', '0912335566', NULL, 1, 4),
(3, 'Hà Văn C', '0912335566', NULL, 1, 4),
(4, 'Đặng Văn D', '0912335566', NULL, 1, 4),
(5, 'Hà Văn Nghi', '0912335566', NULL, 6, 1),
(6, 'Đặng Hà', '0912335566', NULL, 3, 1),
(7, 'Nguyễn Hà Phu', '0912335566', NULL, 1, 4);
...
(34, 1, 1, 1, 0, 4, 20000, 'Kg', '10', 200000),
(35, 1, 1, 2, 0, 4, 30000, 'Kg', '20', 600000),
(36, 1, 1, 3, 0, 4, 25000, 'Gói', '4', 100000),
(47, 6, 6, 4, 0, 11, 20000, 'Kg', '10', 200000),
(48, 6, 6, 5, 0, 11, 30000, 'Kg', '20', 600000),
(49, 6, 6, 6, 0, 11, 40000, 'Gói', '3', 120000),
(57, 3, 3, 1, 0, 4, 20000, 'Kg', '10', 200000),
(58, 3, 3, 2, 0, 4, 30000, 'Kg', '20', 600000),
(59, 3, 3, 3, 0, 4, 25000, 'Gói', '2', 50000),
(60, 4, 4, 1, 2, 4, 20000, 'Kg', '10', 200000),
(61, 4, 4, 2, 2, 4, 30000, 'Kg', '12', 360000),
(62, 4, 4, 3, 2, 4, 25000, 'Gói', '5', 125000);
